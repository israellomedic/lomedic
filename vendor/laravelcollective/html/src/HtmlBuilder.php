...
class HtmlBuilder
{
    ...
    public function setOpenPanel($width=''){
        $width = ($width!="") ? "width:$width;" : '';
        return "<div style='margin:0 auto; $width' ><div class='panel panel-default'>";
    }
    
    public function setClosePanel(){
        return "</div></div>";
    }
    
    public function setTitlePanel($title=''){
        return "<div class='panel-heading'>
                    <div class='panel-title text-center'>$title</div>
                </div>";
    }
    
    public function setOpenPanelBody(){
        return "<div class='panel-body'>";
    }
    
    public function setClosePanelBody(){
        return "</div>";
    }
}